...
//    }
    ...
    public void updateSchedule(int id, ScheduleDto whDto) {

        Schedule updatedWH = sRepos.findById(id).orElseThrow(() -> new RecordNotFoundException("No opening hours found with that id, try a different Id."));
